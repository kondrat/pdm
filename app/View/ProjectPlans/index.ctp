<div class="Projects index">
	<h2><?php echo __('Project\'s Plans');?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $ProjectPlan['ProjectPlan']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ProjectPlan['ProjectPlan']['id']), null, __('Are you sure you want to delete # %s?', $ProjectPlan['ProjectPlan']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
