<div class="items index">
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            <th class="item-drwNumberWidth"><?php echo __('Drw number'); ?></th>
        ...
        foreach ($items as $item):
            ?>
            <tr>
                <td><?php echo h($item['Item']['full_drwname']).' - '.h($item['Itemissue'][0]['issue']); ?>&nbsp;</td>
...
<div class="actions">
    ...
    <div class="item-otherPrj">
        <?php foreach($allPrj as $k=>$v):?>
            <?php echo $this->Html->link($v['Project']['name'], array('controller'=>'items','action'=>'index','prj'=>$v['Project']['id']));?>
        <?php endforeach;?>
    </div>
</div>